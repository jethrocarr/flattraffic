...
#
# This script checks the current version of the database for the flattraffic application
...
if ($help)
{
	print "flattraffic Schema Management Utility\n";
	print "\n";
	print "Usage: schema_manage.pl --schemadir=<schemadir>\n";
	print "\n";
	print "-c, --cfgfile=FILENAME            flattraffic configuration file with MySQL settings.\n";
	print "\n";
