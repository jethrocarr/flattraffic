...
# for the flattraffic application.
#
...
my $db_name		= "flattraffic";	# name of the DB to create
my $db_host		= "localhost";		# MySQL server

my $db_bs_user		= "flattraffic";	# name of the aoconf user to create
my $db_bs_password	= random_password(10);	# random password to generate

# location of config.php file
my $opt_cfgfile = "/etc/flattraffic/config.php";

# tmp file to use for SQL query generation
my $opt_tmpfile = "/tmp/flattraffic_mysqlquery";
...
print "\n";
print "This script setups the flattraffic database components:\n";
print " * flattraffic MySQL user\n";
print " * flattraffic database\n";
print " * flattraffic configuration files\n";
print "\n";
print "THIS SCRIPT ONLY NEEDS TO BE RUN FOR THE VERY FIRST INSTALL OF FLATTRAFFIC.\n";
