...
class page_output
{
	...
	function execute()
	{
		...
		*/
		...
		// general
		$structure = NULL;
		$structure["fieldname"] 	= "username_flattraffic";
		$structure["type"]		= "input";
		$this->obj_form->add_input($structure);
		
		$structure = NULL;
		$structure["fieldname"] 	= "password_flattraffic";
	...
	function render_html()
	{
		...
		print "<p>Please enter your username and password to login to FlatTraffic.</p>";
